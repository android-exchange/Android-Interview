...
- 33. 开启线程的三种方式
- 34. 如何正确的结束一个Thread?
- 35. Thread 与 Runnable 的区别？
- 36. run() 与 start() 方法的区别？
- 37. sleep() 与 wait() 方法的区别？
- 38. wait 与 notify 关键字的区别？
- 39. synchronized 关键字的用法、作用及实现原理？
- 40. volatile 关键字的用法、作用及实现原理？
- 41. transient 关键字的用法、作用及实现原理？
- 42. ReentrantLock、synchronized、volatile 之间的区别？
- 43. 什么是线程池，如何使用?
- 44. 多线程断点续传的实现原理？
- 45. 什么是深拷贝和浅拷贝？
- 46. Java 中对象的生命周期？
...
- 48. 简述 JVM 内存模型和内存区域？
- 49. 简述垃圾回收器的工作原理？
- 50. 如何判断对象的生死？垃圾回收算法？新生代，老生代？
- 51. 哪些情况下的对象会被垃圾回收机制处理掉？
- 52. 垃圾回收机制与调用 System.gc() 的区别？
- [53. 强引用、软引用、弱引用、虚引用之间的区别？](https://github.com/jeanboydev/Android-Interview/blob/master/Java.md#java_53)
- 54. 强引用设置为 null，会不会被回收？
- 55. 简述 ClassLoader 类加载机制？
- 56. 对双亲委派模型的了解？
- [57. String a = "a"+"b"+"c" 在内存中创建几个对象？](https://github.com/jeanboydev/Android-Interview/blob/master/Java.md#java_57)
- 58. 对 Dalvik、ART 虚拟机的了解？
- 59. 对动态加载（OSGI）的了解？
- 60. 常见编码方式有哪些？
- 61. utf-8 编码中的中文占几个字节？int 型占几个字节？
